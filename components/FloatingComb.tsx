...
const POSES: { id: string; pose: Pose }[] = [
  { id: 'hero',                 pose: { x: 0,   y: -13, rz: -4,  rx: 8,  ry: -6,  s: 0.95, o: 1 } },
  { id: 'about-timeline',       pose: { x: 4,   y: 0,   rz: 9,   rx: 20, ry: -16, s: 0.5,  o: 1 } },
  { id: 'product-collections',  pose: { x: 11,  y: 0,   rz: -12, rx: 10, ry: 14,  s: 0.52, o: 1 } },
  { id: 'core-technologies',    pose: { x: -26, y: 0,   rz: 7,   rx: 24, ry: -20, s: 0.5,  o: 1 } },
  { id: 'ai-styling-assistant', pose: { x: 37,  y: -30, rz: 18,  rx: 38, ry: 12,  s: 0.24, o: 0.95 } },
  { id: 'professional-markets', pose: { x: -40, y: 28,  rz: -14, rx: 32, ry: 18,  s: 0.22, o: 0.95 } },
  { id: 'editorial-blog',       pose: { x: 39,  y: -28, rz: 12,  rx: 36, ry: -14, s: 0.22, o: 0.95 } },
  { id: 'request-brochure',     pose: { x: -40, y: 26,  rz: -16, rx: 28, ry: 16,  s: 0.24, o: 0.95 } },
  { id: 'global-contact',       pose: { x: 37,  y: -30, rz: 10,  rx: 20, ry: -10, s: 0.22, o: 0.95 } },
];
